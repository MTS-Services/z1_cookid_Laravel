...
export default function VendorForgotPassword({ status }: { status?: string }) {
    return (
        <AuthLayout title="Forgot password">
            ...
            <div className="mx-auto w-full max-w-md rounded-xl border border-gray-800 bg-gray-900 p-8 shadow-2xl">
                ...
                <Form action={route('vendor.auth.forgot-password.otp-verify')} method="post" className="mt-8 space-y-6">
                    {({ processing, errors }) => (
                        <>
                            <div>
