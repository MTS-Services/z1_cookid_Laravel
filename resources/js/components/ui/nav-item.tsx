                ...
                <Collapsible open={!isCollapsed && isOpen} onOpenChange={setIsOpen}>
                    <CollapsibleTrigger
                        ...
                        className={cn(
                            ...
                            'bg-navy/15 hover:bg-secondary hover:text-white',
                            'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
                            'w-full text-left',
                            isCollapsed ? 'justify-center px-2' : '',
                            level > 0 && !isCollapsed && 'ml-4',
                            itemIsActive && 'bg-secondary text-white hover:bg-navy',
                    ...
                    >
                        ...
                        {isCollapsed && itemIsActive && (
                            <div className="absolute -top-1 -right-1 w-2 h-2 bg-navy rounded-full">
                                <div className="absolute inset-0 bg-navy rounded-full animate-ping" />
                            </div>
                        )}
                    </CollapsibleTrigger>
        ...
        >
            ...
            {!isCollapsed && itemIsActive && (
                <div className="w-1.5 h-1.5 bg-navy rounded-full flex-shrink-0">
                    <div className="absolute w-1.5 h-1.5 bg-navy rounded-full animate-ping" />
                </div>
            )}
        </Link>
    );
