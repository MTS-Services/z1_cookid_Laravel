...
export default function GrowYourCarServiceBusiness() {
    return (
       <div className="py-20 -mt-20 absolute w-full -top-52  z-20">
            <div className="relative z-10 mx-auto container lg:px-8">

            <div className="relative z-10 mx-auto container rounded-lg bg-[#0F172A] p-4 md:p-8 text-center shadow-lg lg:p-12">
