                ...
                <div className="w-lg     bg-gray-900 border border-gray-800 rounded-xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <Link
                                href={route('vendor.auth.forgot-password')}
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full bg-navy hover:bg-navy disabled:opacity-50 text-white py-3.5 rounded-lg font-medium transition-colors cursor-pointer"
                        >
