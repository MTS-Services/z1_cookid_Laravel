                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="border-2 border-dashed border-gray-800 rounded-lg p-8 text-center bg-[#1A1A1A] relative hover:border-gray-600 transition">
                                    ...
                                    />
                                    <FileUp className="mx-auto text-blue-600 mb-2" size={32} />
                                    <p className="text-blue-500 text-sm font-medium">Upload License/Certification</p>
                            ...
                            <div className="flex items-start gap-3">
                                <input type="checkbox" checked={data.terms} onChange={e => setData('terms', e.target.checked)} className="mt-1 accent-blue-600" id="terms" />
                                <label htmlFor="terms" className="text-[11px] text-gray-400 leading-relaxed">
                                    ...
                                    <br />
                                    By creating an account, you agree to the <Link className="text-blue-500 underline">Terms of use</Link> and <Link className="text-blue-500 underline">Privacy Policy</Link>.
                                </label>
                            </div>
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded text-white font-medium transition flex items-center justify-center gap-2"
                            >
